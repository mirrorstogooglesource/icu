...
#define ICU_HAS_ATTRIBUTE(x) __has_attribute(x)
#else
#define ICU_HAS_ATTRIBUTE(x) 0
#endif
#ifdef __has_cpp_attribute
#define ICU_HAS_CPP_ATTRIBUTE(x) __has_cpp_attribute(x)
#else
#define ICU_HAS_CPP_ATTRIBUTE(x) 0
#endif
#ifdef __has_declspec_attribute
#define ICU_HAS_DECLSPEC_ATTRIBUTE(x) __has_declspec_attribute(x)
#else
#define ICU_HAS_DECLSPEC_ATTRIBUTE(x) 0
#endif
#ifdef __has_builtin
#define ICU_HAS_BUILTIN(x) __has_builtin(x)
#else
#define ICU_HAS_BUILTIN(x) 0
#endif
#ifdef __has_feature
#define ICU_HAS_FEATURE(x) __has_feature(x)
#else
#define ICU_HAS_FEATURE(x) 0
#endif
#ifdef __has_extension
#define ICU_HAS_EXTENSION(x) __has_extension(x)
#else
#define ICU_HAS_EXTENSION(x) 0
#endif
#ifdef __has_warning
#define ICU_HAS_WARNING(x) __has_warning(x)
#else
#define ICU_HAS_WARNING(x) 0
#endif
...
#if ICU_HAS_CPP_ATTRIBUTE(clang::fallthrough) || \
    (ICU_HAS_FEATURE(cxx_attributes) &&          \
     ICU_HAS_WARNING("-Wimplicit-fallthrough"))
...
#   define U_EXPORT
#elif defined(_MSC_VER) || (ICU_HAS_DECLSPEC_ATTRIBUTE(dllexport) && \
                            ICU_HAS_DECLSPEC_ATTRIBUTE(dllimport))
