...
/*
 ...
 This table has 4 parts. The parts for Grandfathered tags and redundant
 tags are generated by the following scripts from the IANA language
 tag registry.
 ...
 In addition, there are five ICU-specific entries. They're kept for
 ...
 Finally, ja-latn-hepburn-heploc is mapped to ja-latn-alalc97 because
...
ultag_parse(const char* tag, int32_t tagLen, int32_t* parsedLen, UErrorCode* status) {
    ...
    *(tagBuf + tagLen) = 0;
    ...
    /* check if the tag is grandfathered  or redundant */
