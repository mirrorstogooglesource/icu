...
# build.xml)
CURR_SYNTHETIC_ALIAS = ar_SA.txt\
 en_NH.txt en_RH.txt\
 fil_PH.txt tl.txt tl_PH.txt\
 he_IL.txt iw.txt iw_IL.txt\
 id_ID.txt in.txt in_ID.txt\
 ja_JP.txt ja_JP_TRADITIONAL.txt\
 mo.txt\
 nb_NO.txt no.txt no_NO.txt\
 sh.txt sh_BA.txt sh_CS.txt sh_YU.txt sr_BA.txt\
 sr_CS.txt sr_Cyrl_BA.txt sr_Cyrl_CS.txt sr_Cyrl_RS.txt sr_Cyrl_XK.txt\
 sr_Cyrl_YU.txt sr_ME.txt sr_RS.txt sr_XK.txt sr_YU.txt\
 th_TH.txt th_TH_TRADITIONAL.txt\
 zh_CN.txt zh_HK.txt zh_Hans_CN.txt zh_Hant_TW.txt zh_MO.txt zh_SG.txt\
 zh_TW.txt
...
CURR_SOURCE =\
 am.txt\
 ar.txt ar_AE.txt ar_DJ.txt ar_ER.txt\
 ar_KM.txt ar_LB.txt ar_SO.txt ar_SS.txt\
 bg.txt\
 bn.txt\
 ca.txt\
 cs.txt\
 ...
 fil.txt\
 fr.txt fr_CA.txt fr_CD.txt fr_DJ.txt fr_DZ.txt fr_GN.txt\
 ...
 ms.txt\
 nb.txt\
 nl.txt nl_AW.txt nl_BQ.txt nl_CW.txt nl_SR.txt nl_SX.txt\
 pl.txt\
 pt.txt pt_AO.txt pt_CH.txt pt_CV.txt\
