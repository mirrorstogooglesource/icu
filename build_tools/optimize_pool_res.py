...
def main():
    ...
    # than necessary so just check that they are all in the source
    # directory and strip the path.
    assert all([x.startswith(args.genrb_source_dir) for x in args.source_files])
