...
exit
  echo "LD_LIBRARY_PATH=${DIR1}/lib ${DIR1}/bin/derb dataout/${BUILD}/data/out/build/${RESSUBDIR1}/$res -s ${DIR1}/ -c"
  echo "LD_LIBRARY_PATH=${DIR2}/lib ${DIR2}/bin/derb dataout/${BUILD}/data/out/build/${RESSUBDIR2}/$res -s ${DIR2}/ -c"
